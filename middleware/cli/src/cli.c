...
#if ((defined XM_MODE_CLI) && (defined CLI_COMMAND_NVM))
/*******************************************************************/
static AT_status_t _CLI_nvm_callback(void) {
    // Local variables.
    AT_status_t status = AT_SUCCESS;
...
#if ((defined XM_MODE_CLI) && (defined CLI_COMMAND_SENSORS))
/*******************************************************************/
static AT_status_t _CLI_adc_callback(void) {
    // Local variables.
    AT_status_t status = AT_SUCCESS;
...
#if ((defined XM_MODE_CLI) && (defined CLI_COMMAND_GPS))
/*******************************************************************/
static AT_status_t _CLI_time_callback(void) {
    // Local variables.
    AT_status_t status = AT_SUCCESS;
...
#if ((defined XM_MODE_CLI) && (defined CLI_COMMAND_SIGFOX_EP_LIB) && (defined BIDIRECTIONAL))
/*******************************************************************/
...
#if ((defined XM_MODE_CLI) && (defined CLI_COMMAND_SIGFOX_EP_LIB) && (defined CONTROL_KEEP_ALIVE_MESSAGE))
/*******************************************************************/
static AT_status_t _CLI_so_callback(void) {
    // Local variables.
    AT_status_t status = AT_SUCCESS;
...
#if ((defined XM_MODE_CLI) && (defined CLI_COMMAND_SIGFOX_EP_LIB))
/*******************************************************************/
static AT_status_t _CLI_sb_callback(void) {
    // Local variables.
    AT_status_t status = AT_SUCCESS;
...
#if ((defined XM_MODE_CLI) && (defined CLI_COMMAND_SIGFOX_EP_ADDON_RFP))
/*******************************************************************/
static AT_status_t _CLI_tm_callback(void) {
    // Local variables.
    AT_status_t status = AT_SUCCESS;
...
#if ((defined XM_MODE_CLI) && (defined CLI_COMMAND_CW))
/*******************************************************************/
static AT_status_t _CLI_cw_callback(void) {
    // Local variables.
    AT_status_t status = AT_SUCCESS;
...
#if ((defined XM_MODE_CLI) && (defined CLI_COMMAND_RSSI) && (defined BIDIRECTIONAL))
/*******************************************************************/
static AT_status_t _CLI_rssi_callback(void) {
    // Local variables.
    AT_status_t status = AT_SUCCESS;
...
CLI_status_t CLI_init(void) {
    ...
    una_at_config.parser_context_ptr = &(cli_ctx.at_parser_ptr);
    ...
    for (idx = 0; idx < (sizeof(CLI_COMMANDS_LIST) / sizeof(AT_command_t)); idx++) {
        una_at_status = UNA_AT_register_command(&(CLI_COMMANDS_LIST[idx]));
        UNA_AT_exit_error(CLI_ERROR_BASE_UNA_AT);
    }
#endif
errors:
...
CLI_status_t CLI_de_init(void) {
    ...
    // Unregister commands.
    for (idx = 0; idx < (sizeof(CLI_COMMANDS_LIST) / sizeof(AT_command_t)); idx++) {
        una_at_status = UNA_AT_unregister_command(&(CLI_COMMANDS_LIST[idx]));
        UNA_AT_exit_error(CLI_ERROR_BASE_UNA_AT);
    }
#endif
    // Release AT driver.
