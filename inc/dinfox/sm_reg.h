 ...
 *******************************************************************/
typedef enum {
	SM_REG_ADDR_CONFIGURATION = COMMON_REG_ADDR_LAST,
...
#define SM_REG_CONFIGURATION_MASK_AINF		0x00000001
#define SM_REG_CONFIGURATION_MASK_DIOF		0x00000002
#define SM_REG_CONFIGURATION_MASK_DIGF		0x00000004
