 ...
 *******************************************************************/
typedef enum {
	UHFM_REG_ADDR_CONTROL_1 = COMMON_REG_ADDR_LAST,
	UHFM_REG_ADDR_STATUS,
...
#define UHFM_REG_STATUS_MASK_MESSAGE_STATUS						0x000000FF
#define UHFM_REG_STATUS_MASK_DL_RSSI							0x0000FF00
