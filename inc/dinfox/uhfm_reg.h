...
#define UHFM_REG_SIGFOX_EP_CONFIG_0_MASK_RC					0x0000001F
#define UHFM_REG_SIGFOX_EP_CONFIG_0_MASK_BR					0x00000020
#define UHFM_REG_SIGFOX_EP_CONFIG_0_MASK_NFR				0x000000C0
#define UHFM_REG_SIGFOX_EP_CONFIG_0_MASK_TX_POWER			0x0000FF00
#define UHFM_REG_SIGFOX_EP_CONFIG_0_MASK_TEST_MODE			0x001F0000

#define UHFM_REG_SIGFOX_EP_CONFIG_1_MASK_TCONF				0xFFFF0000
#define UHFM_REG_SIGFOX_EP_CONFIG_1_MASK_TIFU				0x0000FFFF

#define UHFM_REG_SIGFOX_UL_PAYLOAD_0_MASK_CMSG				0x00000001
#define UHFM_REG_SIGFOX_UL_PAYLOAD_0_MASK_MSGT				0x00000006
#define UHFM_REG_SIGFOX_UL_PAYLOAD_0_MASK_BF				0x00000008
#define UHFM_REG_SIGFOX_UL_PAYLOAD_0_MASK_UL_PAYLOAD_SIZE	0x000000F0

#define UHFM_REG_SIGFOX_UL_PAYLOAD_1_MASK_BYTE0				0x000000FF
#define UHFM_REG_SIGFOX_UL_PAYLOAD_1_MASK_BYTE1				0x0000FF00
#define UHFM_REG_SIGFOX_UL_PAYLOAD_1_MASK_BYTE2				0x00FF0000
#define UHFM_REG_SIGFOX_UL_PAYLOAD_1_MASK_BYTE3				0xFF000000

#define UHFM_REG_SIGFOX_UL_PAYLOAD_2_MASK_BYTE4				0x000000FF
#define UHFM_REG_SIGFOX_UL_PAYLOAD_2_MASK_BYTE5				0x0000FF00
#define UHFM_REG_SIGFOX_UL_PAYLOAD_2_MASK_BYTE6				0x00FF0000
#define UHFM_REG_SIGFOX_UL_PAYLOAD_2_MASK_BYTE7				0xFF000000

#define UHFM_REG_SIGFOX_UL_PAYLOAD_3_MASK_BYTE8				0x000000FF
#define UHFM_REG_SIGFOX_UL_PAYLOAD_3_MASK_BYTE9				0x0000FF00
#define UHFM_REG_SIGFOX_UL_PAYLOAD_3_MASK_BYTE10			0x00FF0000
#define UHFM_REG_SIGFOX_UL_PAYLOAD_3_MASK_BYTE11			0xFF000000
