...
#define BPSM_REG_CONFIGURATION_0_MASK_CEFH					0x00000001
#define BPSM_REG_CONFIGURATION_0_MASK_CSFH					0x00000002
#define BPSM_REG_CONFIGURATION_0_MASK_BKFH					0x00000004
#define BPSM_REG_CONFIGURATION_0_MASK_VSTR_RATIO			0x0000FF00

#define BPSM_REG_CONFIGURATION_1_MASK_CHEN_THRESHOLD		0x0000FFFF
#define BPSM_REG_CONFIGURATION_1_MASK_CHEN_TOGGLE_PERIOD	0x00FF0000
