...
#define BPSM_REG_STATUS_CONTROL_1_MASK_BKEN		0x00000003
#define BPSM_REG_STATUS_CONTROL_1_MASK_CHEN		0x0000000C
#define BPSM_REG_STATUS_CONTROL_1_MASK_CHST		0x00000030
