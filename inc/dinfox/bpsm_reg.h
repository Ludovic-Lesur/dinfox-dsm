 ...
 *******************************************************************/
typedef enum {
	BPSM_REG_ADDR_CONTROL_1 = COMMON_REG_ADDR_LAST,
...
#define BPSM_REG_STATUS_MASK_BKENST				0x00000003
#define BPSM_REG_STATUS_MASK_CHENST				0x0000000C
#define BPSM_REG_STATUS_MASK_CHRGST				0x00000030
#define BPSM_REG_STATUS_MASK_VSTR_RATIO			0x0000FF00

#define BPSM_REG_CONTROL_1_MASK_BKEN			0x00000001
#define BPSM_REG_CONTROL_1_MASK_CHEN			0x00000002
