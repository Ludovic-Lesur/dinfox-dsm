 ...
 *******************************************************************/
typedef enum {
	DMM_REG_ADDR_STATUS_1 = COMMON_REG_ADDR_LAST,
...
#define DMM_REG_CONTROL_1_MASK_NODES_SCAN_PERIOD	0x0000FF00
#define DMM_REG_CONTROL_1_MASK_SIGFOX_UL_PERIOD		0x00FF0000
#define DMM_REG_CONTROL_1_MASK_SIGFOX_DL_PERIOD		0xFF000000
