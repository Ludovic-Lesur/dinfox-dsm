 ...
 *******************************************************************/
typedef enum {
	DMM_REG_ADDR_CONFIGURATION = COMMON_REG_ADDR_LAST,
...
#define DMM_REG_CONFIGURATION_MASK_NODES_SCAN_PERIOD	0x000000FF
#define DMM_REG_CONFIGURATION_MASK_SIGFOX_UL_PERIOD		0x0000FF00
#define DMM_REG_CONFIGURATION_MASK_SIGFOX_DL_PERIOD		0x00FF0000
