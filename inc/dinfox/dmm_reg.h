 ...
 *******************************************************************/
typedef enum {
	DMM_REG_ADDR_CONTROL_1 = COMMON_REG_ADDR_LAST,
	DMM_REG_ADDR_STATUS,
...
#define DMM_REG_CONTROL_1_MASK_UL_PERIOD	0x000000FF
#define DMM_REG_CONTROL_1_MASK_DL_PERIOD	0x0000FF00

#define DMM_REG_STATUS_MASK_NODES_COUNT		0x000000FF
