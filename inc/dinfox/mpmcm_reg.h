...
#define MPMCM_CHANNEL_REG_SET(channel)          \
	MPMCM_REG_ADDR_CH##channel##_CONFIGURATION, \
...
#define MPMCM_NUMBER_OF_REG_PER_DATA		(MPMCM_REG_ADDR_CH2_CONFIGURATION - MPMCM_REG_ADDR_CH1_CONFIGURATION)
...
#define MPMCM_REG_MASK_GAIN					0x0000FFFF
#define MPMCM_REG_MASK_ATTEN				0xFFFF0000
