 ...
 *******************************************************************/
typedef enum {
	MPMCM_REG_ADDR_CONTROL_1 = COMMON_REG_ADDR_LAST,
...
#define MPMCM_REG_STATUS_MASK_CH1D		0x00000001
#define MPMCM_REG_STATUS_MASK_CH2D		0x00000002
#define MPMCM_REG_STATUS_MASK_CH3D		0x00000004
#define MPMCM_REG_STATUS_MASK_CH4D		0x00000008
#define MPMCM_REG_STATUS_MASK_MVD		0x00000010
