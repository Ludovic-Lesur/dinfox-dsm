...
static void _LVRM_reset_analog_data(void) {
	...
	NODE_write_register(NODE_REQUEST_SOURCE_INTERNAL, LVRM_REG_ADDR_ANALOG_DATA_2, analog_data_2_mask, analog_data_2);
}
#endif
...
void LVRM_init_registers(void) {
	// Read init state.
	LVRM_update_register(LVRM_REG_ADDR_STATUS_CONTROL_1);
